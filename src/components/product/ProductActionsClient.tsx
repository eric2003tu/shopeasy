...
export default function ProductActionsClient({ id, title, price, image }: Props) {
  ...
  <button data-add-to-cart="true" disabled={loading} onClick={handleAdd} className={`px-6 py-3 rounded-lg text-white ${loading ? 'bg-indigo-400' : 'bg-[#634bc1] hover:bg-[#5340a0]'}`}>
        {loading ? (
